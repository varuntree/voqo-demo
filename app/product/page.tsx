        ...
        <>
          ...
          <section className="py-12 md:py-16">
            <div className="max-w-4xl mx-auto px-4 text-center">
              ...
              {/* Onboarding Content - visible when idle */}
              <div
                className={`transition-opacity duration-300 ${
                  pipelineStatus === 'idle' ? 'opacity-100' : 'opacity-0 pointer-events-none h-0 overflow-hidden'
                }`}
              >
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="flex flex-col items-center text-center p-6 bg-white rounded-2xl border border-stone-200">
                    ...
                    <h3 className="text-lg font-semibold text-stone-900 mb-2">Enter a suburb</h3>
                    <p className="text-sm text-stone-500">Type any Australian suburb to start discovering agencies</p>
                  </div>
                  ...
                  <div className="flex flex-col items-center text-center p-6 bg-white rounded-2xl border border-stone-200">
                    ...
                    <h3 className="text-lg font-semibold text-stone-900 mb-2">AI finds agencies</h3>
                    <p className="text-sm text-stone-500">Our AI researches and extracts agency details in parallel</p>
                  </div>
                  ...
                  <div className="flex flex-col items-center text-center p-6 bg-white rounded-2xl border border-stone-200">
                    ...
                    <h3 className="text-lg font-semibold text-stone-900 mb-2">Get branded demos</h3>
                    <p className="text-sm text-stone-500">Each agency gets a personalized demo page with their branding</p>
                  </div>
                </div>

                {/* What you'll discover */}
                <div className="mt-10">
                  <p className="text-sm text-stone-400 mb-4 font-mono uppercase tracking-wider">What you&apos;ll discover</p>
                  <div className="flex flex-wrap justify-center gap-3">
                    <span className="inline-flex items-center gap-2 px-4 py-2 bg-stone-50 rounded-full text-sm text-stone-600">
                ...
                {/* Hint text */}
                <p className="text-sm text-stone-400 mt-8 font-mono">
                  Try searching Surry Hills, Bondi, or Paddington
                </p>
              </div>
            </div>
          </section>
